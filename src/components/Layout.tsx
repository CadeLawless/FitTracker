      ...
      <div id="navbar" className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-4 py-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <span className="ml-2 text-lg font-bold text-gray-900 dark:text-gray-100">FitTracker</span>
          </div>
        ...
        <div className="grid grid-rows-[auto_1fr_auto] h-[100dvh]">
          ...
          <div className="flex h-16 items-center justify-between px-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900 dark:text-gray-100">FitTracker</span>
            </div>
                ...
                <Link
                  ...
                  className={`flex items-center rounded-lg px-4 py-3 text-sm font-medium transition-colors ${
                    isActive
                      ...
                      : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-900/50 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white'
                  }`}
                >
